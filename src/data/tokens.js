// 149 eligible BEP-20 tokens for Track 1 competition
// Source: BNB Hack competition rules
export const ELIGIBLE_TOKENS = new Set([
...
export function isEligible(symbol) {
  return ELIGIBLE_TOKENS.has(symbol.toUpperCase());
}
