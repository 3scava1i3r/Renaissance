...
console.log('');
console.log('══════════════════════════════════════════════════════');
console.log('  Renaissance — Generating Visual Backtest Report');
console.log('══════════════════════════════════════════════════════\n');
...
<div class="chart-wrap" style="height:240px"><h2>Equity Curve</h2><canvas id="equityChart" height="240"></canvas></div>
...
console.log('══════════════════════════════════════════════════════');
console.log(`  Backtest:      ${result.config.periods} bars @ ${result.config.intervalHours}h`);
console.log(`  Data Source:   ${result.config.dataSource}`);
console.log(`  Total Return:  ${result.results.totalReturn >= 0 ? '+' : ''}${result.results.totalReturn.toFixed(2)}%`);
console.log(`  Sharpe Ratio:  ${result.results.sharpeRatio.toFixed(2)}`);
console.log(`  Max Drawdown:  ${result.results.maxDrawdown.toFixed(2)}%`);
console.log(`  Total Trades:  ${result.results.totalTrades} (${result.results.winningTrades}W / ${result.results.losingTrades}L)`);
console.log(`  Duration:      ${elapsed}s`);
console.log(`  File:          ${outPath} (${sizeKB}KB)`);
console.log('──────────────────────────────────────────────────────');
